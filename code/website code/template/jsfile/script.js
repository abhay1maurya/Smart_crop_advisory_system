...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const TRANSLATIONS = {
        en: {
            ...
            btn_explore_tools: 'Explore Tools',
            btn_watch_demo: 'Watch Demo',
            
            // Services Section
            serv_crop_title: 'Crop Advisory',
            serv_crop_desc: 'Get AI-powered advice on the best crops to grow based on soil health and season.',
            serv_fert_title: 'Fertilizer Guide',
            serv_fert_desc: 'Optimize yield with precise fertilizer dosage and nutrient management plans.',
            serv_disease_title: 'Disease Detection',
            serv_disease_desc: 'Upload leaf photos to instantly identify plant diseases and get cure suggestions.',
            serv_weather_title: 'Weather Forecast',
            serv_weather_desc: 'Real-time weather updates and alerts to plan your farming activities better.',
            serv_bot_title: 'Kisan Chatbot',
            serv_bot_desc: 'Chat with our AI assistant in your local language to solve farming queries instantly.',
            serv_comm_title: 'Community',
            serv_comm_desc: 'Connect with other farmers, share success stories, and learn from experts.',
            service_read_more: 'Read More',
            
            // Welcome/About Section
            about_subtitle: 'About KrishiSahayak',
            welcome_title: 'Welcome To KrishiSahayak',
            welcome_desc_1: 'Your intelligent companion for modern, sustainable farming.',
            welcome_desc_2: 'Our platform uses advanced AI and real‑time analytics to guide you with accurate crop, fertilizer, and disease‑detection recommendations—helping you make smarter decisions, increase productivity, and reduce risks. Empowering farmers through technology.',
            badge_happy_farmers: '5,000+',
            badge_happy_farmers_text: 'Happy Farmers',
            feat_crop_advisory: 'Crop Advisory',
            feat_fertilizer_guide: 'Fertilizer Guide',
            feat_disease_detection: 'Disease Detection',
            feat_strong_community: 'Strong Community',
            btn_contact_us: 'Contact Us',
            
            // Blog Section
            blog_section_title: 'Latest Post',
            ...
            btn_see_more_posts: 'See More Posts',
            
            // Benefits Section
            benefits_section_title: 'Benefits',
            benefits_subtitle: 'Empowering farmers with AI‑driven insights for smarter crop decisions, better yields, and reduced farming risks.',
            benefit_1_title: 'Smart Crop Suggestions',
            benefit_1_desc: 'Receive AI‑powered crop recommendations based on soil nutrients, rainfall, pH, and climatic conditions.',
            benefit_2_title: 'Precise Fertilizer Advice',
            benefit_2_desc: 'Get accurate fertilizer type and dosage suggestions tailored to your soil\'s N‑P‑K levels and crop needs.',
            benefit_3_title: 'Disease & Weed Protection',
            benefit_3_desc: 'Early detection using AI-based image analysis helps safeguard crops from diseases and weed outbreaks.',
            benefit_4_title: 'Real‑Time Weather Alerts',
            benefit_4_desc: 'Stay prepared with live weather warnings and risk predictions to prevent crop damage and reduce losses.',
            
            // Community Section
            comm_section_title: 'Community & Knowledge Hub',
            comm_sub_title: 'Read expert articles, discuss crop problems, and meet our top farmers.',
            feat_article_title: 'Expert Articles & Blogs',
            feat_article_desc: 'Read research-backed articles and success stories directly from agricultural scientists.',
            feat_forum_title: 'Farmer\'s Problem Forum',
            feat_forum_desc: 'Post photos of your crop issues and get instant solutions from peers and experts.',
            feat_top_title: 'Top Farmers Spotlight',
            feat_top_desc: 'Meet the highest yielders of the season and learn their farming techniques.',
            role_expert: 'Verified Expert',
            desc_expert: 'Published 50+ articles on soil health. Available for consultation.',
            btn_read_articles: 'Read Articles',
            role_top_farmer: 'Top Farmer',
            desc_farmer: 'Record wheat yield in Punjab 2024. Active community mentor.',
            btn_view_profile: 'View Profile',
            
            // Tool Mastery Section
            mastery_badge: 'User Guide',
            mastery_title: 'Master Your Farm Tools',
            mastery_subtitle: 'Select a tool to see how it works in 3 simple steps.',
            tool_crop_title: 'Crop Advisor',
            tool_crop_subtitle: 'Soil-based prediction',
            tool_fert_title: 'Fertilizer Calc',
            tool_fert_subtitle: 'Dosage optimizer',
            tool_disease_title: 'Disease AI',
            tool_disease_subtitle: 'Photo diagnosis',
            tool_weather_title: 'Weather Alerts',
            tool_weather_subtitle: 'Real-time updates',
            
            // Crop Mastery Pane
            mastery_crop_title: 'How to use Crop Advisory',
            mastery_crop_desc: 'Maximize yield by choosing the scientifically best crop for your soil.',
            step_crop_1_title: 'Input Soil Data',
            step_crop_1_desc: 'Enter N-P-K values from your Soil Health Card.',
            step_crop_2_title: 'Select Region',
            step_crop_2_desc: 'Choose your State and District for climate data.',
            step_crop_3_title: 'Get Analysis',
            step_crop_3_desc: 'Click "Predict" to see the recommended crop list.',
            btn_launch_crop: 'Launch Crop Tool',
            
            // Fertilizer Mastery Pane
            mastery_fert_title: 'How to use Fertilizer Calculator',
            mastery_fert_desc: 'Save money and soil health by using the exact chemical dosage.',
            step_fert_1_title: 'Select Crop',
            step_fert_1_desc: 'Tell us what you are currently growing.',
            step_fert_2_title: 'Current Nutrients',
            step_fert_2_desc: 'Enter current Nitrogen/Potassium levels.',
            step_fert_3_title: 'Calculate',
            step_fert_3_desc: 'Get a precise Urea/DAP schedule.',
            btn_launch_calc: 'Launch Calculator',
            
            // Disease Mastery Pane
            mastery_disease_title: 'How to use Disease Detection',
            mastery_disease_desc: 'Identify plant diseases instantly with just a photo.',
            step_disease_1_title: 'Capture',
            step_disease_1_desc: 'Take a clear photo of the affected leaf.',
            step_disease_2_title: 'Upload',
            step_disease_2_desc: 'Upload the image to our AI scanner.',
            step_disease_3_title: 'Cure',
            step_disease_3_desc: 'Get immediate diagnosis and medicine list.',
            btn_launch_scanner: 'Launch Scanner',
            
            // Weather Mastery Pane
            mastery_weather_title: 'How to use Weather Alerts',
            mastery_weather_desc: 'Plan your sowing and harvesting with precision forecasts.',
            step_weather_1_title: 'Location Access',
            step_weather_1_desc: 'Allow GPS access for local data.',
            step_weather_2_title: 'View Forecast',
            step_weather_2_desc: 'See 7-day predictions for rain & temp.',
            step_weather_3_title: 'Alerts',
            step_weather_3_desc: 'Receive SMS for upcoming storms.',
            btn_check_weather: 'Check Weather',
            
            // Testimonials Section
            testi_section_title: 'What Farmers Say',
            testi_sub_title: 'Stories of success from across the country.',
            testi_1_text: '"KrishiSahayak helped me identify a fungus on my wheat crop early. I saved my entire harvest thanks to the quick diagnosis!"',
            testi_2_text: '"The fertilizer calculator is a game changer. I used to over-fertilize, but now I save money and get better yield."',
            testi_3_text: '"Connecting with Dr. Amit through the community feature solved my soil pH issue. Highly recommended for every farmer."',
            
            // Contact Section
            contact_sub: '24/7 Support',
            contact_section_title: 'Get In Touch',
            contact_desc: 'Have questions about our services or need farming advice? Our experts are ready to help you grow better.',
            lbl_location: 'Our Location',
            ...
            tab_crop: 'Crop Advisory',
            tab_fert: 'Fertilizer Guide',
            tab_disease: 'Disease Detection',
            tab_weather: 'Weather Forecast',
            tab_chat: 'Farming Chatbot',
            tab_community: 'Strong Blog Community',
            footer_newsletter: 'Newsletter',
            footer_news_desc: 'Subscribe to get the latest farming news and updates directly to your inbox.',
            footer_copyright: '© 2025 KrishiSahayak. All Rights Reserved.',
